package com.ljh.demo.test.generator.helper;


import com.alibaba.fastjson.JSONObject;
import com.google.common.io.Files;
import com.ljh.demo.annotation.Helper;
...
public class GeneratorHelper {
    ...
    private static String getFilePath(TGeneratorConfig configure, String packagePath, String suffix, boolean serviceInterface) {
    ...
    private Template getTemplate(String templateName) throws Exception {
        ...
        if (!file.exists()) {
            ...
            FileUtils.copyInputStreamToFile(Objects.requireNonNull(AddressUtil.class.getClassLoader().getResourceAsStream("classpath:generator/" + templateName)), file);
        }
